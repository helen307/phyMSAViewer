...
Users can also access the uniprotToPhy function through the ShinyApp (the fourth command indicated above). This Shiny App will also alloq users to view the amino-acids' differences between MSA by selecting the window size.

...
Users can also access the uniprotToPhy function through the [ShinyApp - Visualize your phylogenetic trees with MSA](https://helen307.shinyapps.io/phyMSAViewer-ShinyApp/). This Shiny App will also alloq users to view the amino-acids' differences between MSA by selecting the window size.
